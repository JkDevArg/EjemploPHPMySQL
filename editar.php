...
<main class="container">
    ...
    <div class="row">
        <div class="col">
            <form class="row g-3" action="guarda.php" method="POST" autocomplete="off">
                ...
                <div class="col-md-12">
                    <div class="form-check">
                        <input type="checkbox" class="form-check-input" name="invetariable" id="inventariable" value="1" <?php if($row['inventariable']){ echo 'checked'; } ?>>
